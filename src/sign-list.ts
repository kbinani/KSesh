export class SignList {
  ...
  static readonly signs: ReadonlyArray<ReadonlyArray<string>> = [
    ["A1", "𓀀"],
    ["A2", "𓀁"],
    ["A3", "𓀂"],
    ["A4", "𓀃"],
  ...
  // prettier-ignore
  static readonly special: ReadonlyArray<ReadonlyArray<string>> = [
    ...
    ["#3", "\u{13448}"],
    ["#4", "\u{1344e}"],
    ["#12", "\u{1344b}"], ["#21", "\u{1344b}"],
    ["#13", "\u{13449}"], ["#31", "\u{13449}"],
    ["#14", "\u{1344f}"], ["#41", "\u{1344f}"],
    ["#23", "\u{1344c}"], ["#32", "\u{1344c}"],
    ["#24", "\u{13452}"], ["#42", "\u{13452}"],
    ["#34", "\u{13450}"], ["#43", "\u{13450}"],
    ["#123", "\u{1344d}"], ["#132", "\u{1344d}"], ["#213", "\u{1344d}"], ["#231", "\u{1344d}"], ["#312", "\u{1344d}"], ["#321", "\u{1344d}"],
    ["#124", "\u{13453}"], ["#142", "\u{13453}"], ["#214", "\u{13453}"], ["#241", "\u{13453}"], ["#412", "\u{13453}"], ["#421", "\u{13453}"],
    ["#134", "\u{13451}"], ["#143", "\u{13451}"], ["#314", "\u{13451}"], ["#341", "\u{13451}"], ["#413", "\u{13451}"], ["#431", "\u{13451}"],
    ["#234", "\u{13454}"], ["#243", "\u{13454}"], ["#324", "\u{13454}"], ["#342", "\u{13454}"], ["#423", "\u{13454}"], ["#432", "\u{13454}"],
    ["#1234", "\u{13455}"], ["#1243", "\u{13455}"], ["#1324", "\u{13455}"], ["#1342", "\u{13455}"], ["#1423", "\u{13455}"], ["#1432", "\u{13455}"], ["#2134", "\u{13455}"], ["#2143", "\u{13455}"], ["#2314", "\u{13455}"], ["#2341", "\u{13455}"], ["#2413", "\u{13455}"], ["#2431", "\u{13455}"], ["#3124", "\u{13455}"], ["#3142", "\u{13455}"], ["#3214", "\u{13455}"], ["#3241", "\u{13455}"], ["#3412", "\u{13455}"], ["#3421", "\u{13455}"], ["#4123", "\u{13455}"], ["#4132", "\u{13455}"], ["#4213", "\u{13455}"], ["#4231", "\u{13455}"], ["#4312", "\u{13455}"], ["#4321", "\u{13455}"],
    ["\\shading1", "\u{13447}"],
    ["\\shading2", "\u{1344a}"],
    ["\\shading3", "\u{13448}"],
    ["\\shading4", "\u{1344e}"],
    ["\\shading12", "\u{1344b}"], ["\\shading21", "\u{1344b}"],
    ["\\shading13", "\u{13449}"], ["\\shading31", "\u{13449}"],
    ["\\shading14", "\u{1344f}"], ["\\shading41", "\u{1344f}"],
    ["\\shading23", "\u{1344c}"], ["\\shading32", "\u{1344c}"],
    ["\\shading24", "\u{13452}"], ["\\shading42", "\u{13452}"],
    ["\\shading34", "\u{13450}"], ["\\shading43", "\u{13450}"],
    ["\\shading123", "\u{1344d}"], ["\\shading132", "\u{1344d}"], ["\\shading213", "\u{1344d}"], ["\\shading231", "\u{1344d}"], ["\\shading312", "\u{1344d}"], ["\\shading321", "\u{1344d}"],
    ["\\shading124", "\u{13453}"], ["\\shading142", "\u{13453}"], ["\\shading214", "\u{13453}"], ["\\shading241", "\u{13453}"], ["\\shading412", "\u{13453}"], ["\\shading421", "\u{13453}"],
    ["\\shading134", "\u{13451}"], ["\\shading143", "\u{13451}"], ["\\shading314", "\u{13451}"], ["\\shading341", "\u{13451}"], ["\\shading413", "\u{13451}"], ["\\shading431", "\u{13451}"],
  ...
  private static _mapping: ReadonlyArray<ReadonlyArray<string>> = [];

  private static get mapping(): ReadonlyArray<ReadonlyArray<string>> {
    if (this._mapping.length === 0) {
      const m: ReadonlyArray<string>[] = [...this.signs].reverse();
      m.push(...this.special);
  ...
  static map(s: string, offset?: number): ReadonlyArray<string> | undefined {
