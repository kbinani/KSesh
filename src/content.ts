...
type Cursor = { x: number; y: number; height: number };
export class Rect {
  constructor(
    readonly x: number,
    readonly y: number,
...
export type ClosedRange = { lowerBound: number; upperBound: number };

export function rangeIntersectsWith(x: ClosedRange, y: ClosedRange): boolean {
